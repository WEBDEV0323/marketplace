...
<main class="my-account-page">
  ...
  @endif
            ...
            <form action="{{ route('change.pass') }}" class="sign-in-form common-form" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <label for="re_password">Re-Password <span>*</span></label>
                </div>

                <div class="form-group">
                    <input type="otp" class="form-control" name="otp" id="otp">
