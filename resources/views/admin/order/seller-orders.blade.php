                        ...
                        <table id="myTable" class="table table-head-bg table-head-primary table table-striped table-bordered basic-datatable" cellspacing="0" width="100%">
                            ...
                            @if(isset($data))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select <?php if($order->status == 'refunded') echo 'disabled'; ?>  size="1" class="form-control m-0 selectOrder" onchange = "get_dist(this,<?php echo $order->id;?>)" id="order{{$order->id}}"  name="order{{$order->id}}">
                                    ...
                                    <td>
                                        <a href = "{{ route('vendor_product_detail', ['id' => $order->var_id]) }}" class="btn btn-primary btn-sm m-1">Product</a> 
                                        <a href = "{{ url('dashboard/order-details/'.$order->id) }}" class="btn btn-primary btn-sm m-1">View</a> 
