                            ...
                            <form action="{{ route('user.edit') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="buttons">
                                 ...
                                 {{--   <label for="profile_input" class="btn btn-info change-btn">
                                    ...
                                    <a href="{{ route('user.image.remove.all',$data->id) }}"><input type="button" value="Remove" class="btn btn-info"></a> --}}
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="first_name" value="<?php echo $data->first_name; ?>" class="form-control" placeholder="First Name" disabled>
                                        <!-- <span class="form-text">Please enter your Firstname</span> -->
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label">Last Name</label>
                                        <input type="text" name="last_name" value="<?php echo $data->last_name; ?>" class="form-control" placeholder="Last Name" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input disabled type="email" name="email" value="<?php echo $data->email; ?>" class="form-control" placeholder="Enter Email" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input disabled type="email" name="email" value="<?php echo $payout_email; ?>" class="form-control" placeholder="Enter Email" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label">Discount Coupon Code</label>
                                        <input type="text" name="coupon_code" value="<?php echo $data->coupon_code; ?>" class="form-control" placeholder="Enter Discount Coupon Code" disabled>
                                        <!-- <span class="form-text">Please enter your Lastname</span> -->
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" value="<?php echo $data->phone; ?>" class="form-control" disabled placeholder="Phone">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="commission_setting" class="form-control" id="select_commission_setting" disabled>
                                            ...
                                            <table class="table table-borderless m-0 fixed-header">
                                                ...
                                                @foreach($dataTableData as $i=>$value)
                                                    ...
                                                    <tr> 
                                                        ...
                                                        <td><input type="checkbox" {{$value["paidStatus"]}} disabled></td>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <div class="buttons text-left mb-0">
                                        ...
                                        <a href="{{route('affiliates') }}">  <input  type=" button" class="btn btn-info" value="Cancel"> </a>
...
<script type="text/javascript">
    ...
    // $(document).on('click','.paid_checkbox',function(){
    //     var user_id = $(this).data('user_id');
    //     var month_year = $(this).data('month_year');
    ...
    //     }
    //     $.ajax({
    //         url: "{{ route('payout.amount') }}",
    //         method: 'post',
    //         data: {
    //             _token: "{{ csrf_token() }}",
    //             user_id: user_id,
    //             payment_month_year: month_year,
    //             payment_status: payment_status,
    //             commission:commission
    //         },
    //         success: function () {
    //             $('.payment_status').html('Payment status has been updated!');
    //             setTimeout(()=>{
    //                 $('.payment_status').html('');
    //             }, 2000);  
    //         }
