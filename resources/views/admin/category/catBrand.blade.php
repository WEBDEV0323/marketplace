                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge badge-success badge-sm badge-pill">{{App\Models\ShopCategory::STATUS_ACTIVE}}</span>
                                        </td>
                                        @else
                                        <td><span class="badge badge-danger badge-sm badge-pill">{{App\Models\ShopCategory::STATUS_NOT_ACTIVE}}</span>
                                        </td>
                                        @endif
                                        <td><a href="{{ route('product-catgory', ['slug' => $shop_category['id'], 'brand_slug' => $brand_slug,'gender'=>$shop_category['gender']]) }}" class="btn btn-primary btn-sm m-1">View</a></td>
                                    </tr>
                                    @endforeach
                                    @endif
                                </tbody>
