            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form action="{{ route('aboutus.content.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row white-box-div news-row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea required name="our_story" id="our_story">{{$our_story->description ?? ''}}</textarea>
                                     </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Our Mission </label>
                                        <textarea required name="our_mission" id="our_mission">{{$our_mission->description ?? ''}}</textarea>
                                     </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Our Vision  </label>
                                        <textarea required name="our_vision" id="our_vision ">{{$our_vision->description ?? ''}}</textarea>
                                     </div>
                                </div>
                                <div class="col-md-12">
