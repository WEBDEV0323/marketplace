            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ route('aboutus.keymetrics.update',[$data->id]) }}" method="post" enctype="multipart/form-data" class="brands-form">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" name="title" value="{{$data->titile}}" required class="form-control">
                                    </div>
                                </div>
                                @if($data->id == 65)                                
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Value </label>
                                            <input type="text" name="value" value="{{$data->sub_titile}}" required class="form-control">
                                        </div>
                                    </div>
                                @else 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="plus_sign" class="custom-select">
                                            ...
                                            <option value="Yes" {{($data->description == 'Yes')?'selected':''}}>Yes</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
