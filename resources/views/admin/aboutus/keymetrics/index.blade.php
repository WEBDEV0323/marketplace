                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($row->description == 'Yes') 
                                                <span class="badge badge-success badge-sm badge-pill">Yes</span>
                                            @else
                                                <span
                                                    class="badge badge-danger badge-sm badge-pill">No </span>
                                                </td> 
                                            @endif
                                        <td>
                                        <a href='{{route('aboutus.keymetrics.edit',[$row->id])}}'class="btn btn-primary btn-sm m-1">Edit</a> 
                                                {{-- <a href='{{route('aboutus.keymetrics.delete',[$row->id])}}'
...
<script>
    ...
    $(document).ready(function() {
        // let url = "{{route('aboutus.keymetrics.create')}}";
        // $('<div class="pull-right">' + '' +
        //     '</div>').appendTo("#myTable_wrapper .dataTables_filter");
        // $("#myTable_length").append('<a href="'+url+'" class="btn btn-primary btn-shadow" >Add key Metrics</a>');
    });
</script>
