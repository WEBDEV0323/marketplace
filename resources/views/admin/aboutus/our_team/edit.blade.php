            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ route('aboutus.ourteam.update',[$data->id]) }}" method="post" enctype="multipart/form-data" class="brands-form">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" name="name" value="{{$data->titile}}" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Position </label>
                                        <input type="text" name="position" value="{{$data->sub_titile}}" required class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Description </label> 
                                        <textarea id="description" name="description" required rows="4" cols="50" class="form-control">{{$data->description}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Image</label>
                                        <div class="image-box">
                                            <img id="blah" src="{{url('/').'/storage/about_us/our_team/'.$data->image}}" alt="your image" />
                                        </div>
                                        <div class="buttons"> 
                                            <span>
                                                Choose
