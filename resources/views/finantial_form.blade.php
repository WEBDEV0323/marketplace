                        ...
                        <div class="panel-head">
                          ...
                          <form action = "{{route('finantial.edit.process')}}" method = "post" enctype="multipart/form-data" class="brands-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"    name = "name" id="exampleInputEmail1" placeholder="Enter Name" required>
                                    
                                </div>
                                <div class="form-group amount_append">
                                    <label for="exampleInputEmail1">Amount</label>
                                    <input type="text"   class="amount" id="amount" name = "amount" id="exampleInputEmail1" placeholder="Enter Your Amount" required>                                    
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"    name = "note" id="exampleInputEmail1" placeholder="Enter Note" required>
