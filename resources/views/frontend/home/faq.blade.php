        ...
        <div class="faq-sec">
            <div class="accordion" id="faqs-group1">
                ...
                <div id="faq2" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>We <strong>only</strong> accept returns on items sold by The Marketplace. The deadline to return or exchange a product is <strong> 7 days</strong> from when the order was delivered. </p>
                        <div class="mb-3">
                            <img  src="{{asset('assets/images/exchange-img.png')}}" class="w-100"/>
                        </div>
                       <p> <strong>Please note:</strong> Any items sold by Sellers will not be eligible for exchange or refunds. However, we do allow all items that have been purchased to be relisted and resold on our platform at any time. </p>
                    </div>
                </div>
                ...
                <div id="faq3" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <h5>Buying</h5>
                        <p>When buying a product on The Marketplace you will come across two Fee’s: 1) Processing Fee and 2) Shipping Fee.  </p>
                        <p>The Processing Fee is a fixed percentage of 7.5% of the item's price and will be included in the total at checkout.</p>
                        ...
                        <h5>Selling</h5>
                        <p>When buying a product on The Marketplace you will come across two Fee’s: 1) Transaction Fee and 2) Shipping Fee.</p>
                        <p>The Transaction Fee is variable and will depend on the loyalty of the customer. The percentage will depend on how many items the customer has bought/sold on The Marketplace, as the more that is bought/sold the lower the fee. There will be 5 tiers for sellers where the Fees range from 9% - 7%. </p>
                        <p>The Shipping Fee is variable and will depend on standard shipping factors, such as: Weight of item, Cost of item and Size of item. This is so that we can ensure all products are sent securely and safely to you and if any problems do occur while in transit, all items will be fully insured – allowing all parties ease of mind.</p>
                    </div>
                </div>
                ...
                <div id="faq5" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>If you have a problem with your order, please contact us immediately! Use the ‘Contact Us’ page located at the bottom of every page or click the link below...</p>
                ...
                <div id="faq6" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>Failure to complete a sale will result in a fee up to 10% of the transaction price and indefinite suspension of your account. This fee is dependent on the number of sales you have made on The Marketplace as well as the severity of the authentication failure (if your product fails authentication). Your account can be subject to a penalty fee if you sell and ship us:</p>
                ...
                <div id="faq10" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        ...
                        <p>If you are having trouble viewing your prepaid label, you can also view it in <a href="javascript:void(0);" class="faq-cusor">My Dashboard > Sold Items</a></p>
                ...
                <div id="faq11" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>We aim to have all orders delivered within 5 business days. We will alert you via email if any problems occur with your order.</p>
                    </div>    
                </div>
                ...
                <div id="faq12" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        ...
                        <p>If you are a buyer and no longer want the item that you have purchased, you are eligible to sell that product on our platform at any time, as we sadly do not offer refunds on these types of transactions. </p>
                    </div>    
                </div>
                ...
                <div id="faq14" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>If you are having trouble remembering your password, you can reset it here <a class="text-danger" href="{{route('lost_password')}}">FORGET PASSWORD </a></p>
                ...
                <div id="faq16" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>If you believe your account has been compromised, please change your password <strong>IMMEDIATELY</strong>. If you cannot access your account, contact us at the earliest convenience. </p>
                ...
                <div id="faq18" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        ...
                        <p>If your account has been blocked due to failure to comply with The Marketplace’s rules and guidelines, there is nothing we can do to help. There is a strict policy which helps to maintain a secure and trustworthy platform, which everyone can benefit from.</p>
                    </div>    
                </div>
                ...
                <div id="faq19" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        ...
                        <p>You can activate two-step verification by going to the security tab in your <a href="javascript:void(0);" class="faq-cusor">‘Dashboard’</a> and opting in to two-step verification. Upon opting in, you will be asked to input your phone number. You will then receive a random 6-digit code. By entering your specific code into the display, you’ll finish the activation. You can choose to remember this device, which will verify your trusted device and not require two-step verification when attempting to log in for the next 30 days. After 30 days, you will need to re-verify your device. </p>
                       ...
                       <h6>What if I don’t have my phone when I’m signing in? </h6>
                        ...
                        <p>Yes. To change the number used to verify your account, go to the security tab in your <a href="javascript:void(0);" class="faq-cusor">Dashboard</a> and disable two-step verification. After disabling two-step verification, you can re-enable it to enter a new number.  </p>
                       ...
                       <h6>Why do I have to verify my device every time I log in?  </h6>
                        ...
                        <p>Yes. Simply go to your security tab in your <a href="javascript:void(0);" class="faq-cusor">Dashboard</a> and you can toggle two-step verification off. Prior to turning off two-step verification, you will be prompted one final time to verify your identity.  </p>
                ...
                <div id="faq20" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>To manage all your email notifications, please head over to <a href="javascript:void(0);" class="faq-cusor">My Dashboard > My Subscriptions</a> and it will be here where you can sign up/unsubscribe to email notifications.</p>
                    </div>
                </div>
                ...
                I have requested to sell. When will my account be verified?</button>
                <div id="faq21" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>Majority of accounts will be verified within 24 hours of the request. However, some accounts may take slightly longer as we conduct a full investigation into each account to ensure The Marketplace is a safe and secure platform for all users. </p>
                    </div>
                </div>
                ...
                <div id="faq22" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        ...
                        <p>Please do not worry if your account is taking longer to process as this is all to ensure The Marketplace is a safe and secure platform. However, if you feel that your account has been pending for a while. Please <a href="{{route('contactus')}}">contact us</a>. </p>
                    </div>    
                </div>
                ...
                What is the T.MP Processing Fee & Transaction Fee?</button>
                <div id="faq24" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>When buying, the ‘Processing Fee’ is fixed at 9% and as you begin to buy more on our platform, there is potential to decrease this fee. Therefore you pay a lower price for the same product. </p>
                        <p>When selling, the ‘Transaction Fee’ is calculated by customer loyalty. Upon creating a new account, the processing fee is fixed at 9% and as you begin to sell more on our platform, this will reduce to 7%.</p>
                    </div>
                </div>
                ...
                <div id="faq25" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>Once you’ve sold your item and it passes our authentication process, then your pay-out will be sent immediately to your chosen pay PayPal pal account (In your ‘Bank Information’). </p>
                        ...
                        <p>If you are still experiencing issues with your pay-out, please contact us. </p>
                    </div>    
                </div>
                ...
                <div id="faq30" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        ...
                        <p>Please note that if for any reason a counterfeit item does get through our authentication process, we apologise immensely and we will rectify this issue immediately. </p>
                ...
                <div id="faq33" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p> 1. Head over to <a href="javascript:void(0);" class="faq-cusor">My Dashboard > Sold Items</a> and click on the “Shipping Label” button to load up your specific shipping label. Print both the Shipping label and order invoice out and place the order invoice with the item you are selling. </p>
                        ...
                        <p> 6. Once your item has been securely packaged up, you should find your nearest UPS drop off point and ship the item. </p>
                    </div>    
                </div>
                ...
                <div id="faq35" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        <p>1. Head over to <a href="javascript:void(0);" class="faq-cusor">My Dashboard > Sold Items</a> and click on the “Shipping Label” button to load up your specific shipping label. Print both the Shipping label and order invoice out and place the order invoice with the item you are sending. </p>
                        <p>2. Place the item into a bigger and sufficiently sized shipping box that is no more than 5 cm larger than your item on each side. Remove all old labels and stickers from the shipping box if you are reusing an old box. </p>
                        <p>3. Use bubble wrap and/or packing paper to ensure your item is secure while in transit. </p>
                        <p>4. Seal the package securely to ensure your item is not vulnerable to damage. We recommend that you use strong shipping tape that will hold all flaps of the shipping box. </p>
                        <p>5. Tape and secure the provided shipping label to the outside of your shipping box.  </p>
                ...
                <div id="faq36" class="collapse" data-parent="#faqs-group1">
                    <div class="faq-para p-3">
                        ...
                        <p>Once it has passed authentication, we will then release your pay-out to you and your item will be shipped to its new owner. The rest remains history...</p>
                    </div>    
                </div>
