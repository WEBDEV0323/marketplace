                ...
                <div class="owl-carousel owl-theme single-img-slider">
                    <div class="item">
                        <div class="img-wrapper">
                            ...
                            <img src="{{ url('/').'/storage/seller-product/'.$product->id.'/'.$product->feature_image;}}"
                                alt="" class="img-fluid">
                            <?php }else{ ?>
                            <img src="{{ url('/').'/storage/product/'.$p->id.'/'.$p->feature_image;}}" alt="abc"
                                class="img-fluid">
                            <?php } ?>
                            @else
            ...
            <div class="column column-details">
                <div class="inner-wrapper">
                    ...
                    <div class="product-price">
                        ...
                        @if((int)$getLowestPrice->sale_price > 0 && (int)$getLowestPrice->regular_price >
                        $getLowestPrice->sale_price)
                    ...
                    <form action="">
                        <h4 class="size-guide"><span class="view_single_page_show"></span> <a data-toggle="modal"
                                data-target="#sizeGuide_Modal"> View Size Guide</a></h4>
                        <div class="product-slider-wrapper">
                            @php $getTotalSlidecount = isset($product->prod_size)?
                            count($product->prod_size->where('flags', 1)): 0; @endphp


                            <div
                                class="owl-carousel owl-theme product-pills-slider {{($getTotalSlidecount > 5)?'slide_more_then_five':''}}">
                                {{-- for admin sizes --}}
                                ...
                                <div class="item" @if($sizes->size_id == 111) style="margin-left:207%;" @endif >
                                    <div class="item-wrapper">
                                        ...
                                        @endphp
                                        <button onclick="wishlist({{$sizes->product_id}}, {{$sizes->size_id}});"
                                            class="pills-link-admin {{$product_is_wishlist}} pills-link <?php echo ($sizes->quantity > 0 ? '' : 'quantity-disabled' );?>"
                                            <?php echo ($sizes->quantity > 0 ? '' : 'disabled' );?> data-size_id =
                                            '{{$sizes->size_id}}' data-variation_id = '{{$sizes->id}}'
                                            data-toggle="pill" type="button">
                                            @if($sizes->size != null)
                                            {{$sizes->size->size}}
                                            @else
                                            {{$sizes->size_id}}
                        ...
                        <div class="product-quantity">
                            <div class="quantity">
                                <div class="value-button" id="decrease" onclick="decreaseValue()"
                                    value="Decrease Value"><i class="uil uil-minus"></i></div>
                                <input type="number" id="number" value="01" readonly />
                                <div class="value-button" id="increase" onclick="increaseValue()"
                                    value="Increase Value"><i class="uil uil-plus"></i></div>
                            </div>
                            <div class="wishlist_and_compayr_btns">
                                <div class="action-buttons">
                                    <a style="color: rgb(173, 173, 173);" class="btn Add-to-Wishlist" style="color:red;"
                                        id="addWishlist"><i class="uil uil-heart-alt"></i></a>
                                    ...
                                    <a href="javascript:void(0)" class="btn add_to_comper_btn">
                                        <svg width="18" height="21" viewBox="0 0 20 21" fill="none"
                        ...
                        <div class="add_to_card_btn_show">
                            ...
                            <button class="btn add-to-cart-button" id="addToCart" disabled style="background:#dcdcdc;"
                                type="button">Add to Cart <i class="ml-1 fa fa-shopping-cart"></i></button>
                        </div>
                    </form>
                    ...
                    <div class="social">
                        ...
                        <p>
                            <?php $site_url = route('single-product', ['id' => $product->id,'brand' =>
                             $product->brand->brand_slug,'category'=> $product->shop_category->shop_cat_slug,'product_slug'=>$product->product_slug]) ;?>
                            <a href="http://www.facebook.com/sharer.php?u=<?=$site_url;?>"><i
                                    class="fab fa-facebook-f"></i></a>
                            <a href="https://twitter.com/share?url=<?=$site_url?>&amp;text=Simple%20Share%20Buttons&amp;hashtags=simplesharebuttons"
                                target="_blank"><i class="fab fa-twitter"></i></a>
                            <a
                                href="mailto:?Subject=The Marketpalce&amp;Body=I%20saw%20this%20and%20thought%20of%20you!%20 <?=$site_url;?>"><i
        ...
        <div style="display:none" class="product-layout single_page_product">
            ...
            <div class="column product-details-column">
                ...
                <ul class="nav nav-pills nav-pills-product" id="pills-products" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " id="used-product" data-toggle="pill"
                            href="#pills-used-product">Pre-Loved</a>
                    </li>
                </ul>
                        ...
                        <div class="product-size-wrapper">
                            <div class="inner product-sizes product-slider-wrapper" id="product-sizes">
                                <div
                                    ...
                                    <div class="item" @if( isset($sizes['size']) && $sizes['size']=="One Size" )
                                        style="width:0% !important; margin-left:207%;" @endif>
                                        ...
                                        <button class="pills-general pills-link-new-product pills-link
                                                    ...
                                                    //                     }
                                                    //                 } else {
                                                    //                 if(isset($sizes[" product_size"][0]) ||
                                            isset($sizes["product_size"][1]) ) // { // } // else // { //
                                            echo 'quantity-disabled' ; // } // } // } // }else { //
                                            echo 'quantity-disabled' ; // } ?>
                                            " data-product_id = "{{$product->id}}" data-size_id="{{$sizes['id']}}"
                                            data-flags='1' data-toggle="pill" type="button" >
                                            ...
                                            <?php
                                                        ...
                                                        // if(isset($product_size['products']) && $product_size['products'] != NULL) {
                                                         ?>
                                            // <span
                                                class="pill-price">£{{number_format($product_size['sale_price'],2)}}</span>
                                            <?php
                                                        // break;
                                                        // }
                                                        // }
                                    ...
                                    <div class="item">
                                        <button class="pills-general pills-link-new-product pills-link by_new_wishlist {{$product_is_wishlist_new}}
                                                        <?php //if($new_products->product_sizes_quantity < 1 ){ echo "
                                            quantity-disabled"; } ?>"
                                            data-product_id="{{$product->id}}" data-size_id="{{$new_products->size_id}}"
                                            data-flags='1' data-toggle="pill" type="button">
                                            {{$new_products->size}}
                                            <?php
                                    ...
                                    <div class="item">
                                        <button
                                            class="pills-general pills-link-new-product pills-link  {{$product_is_wishlist_new}}
                                                                <?php echo ($new_products_row->product_sizes_quantity < 1) ? 'quantity-disabled' : 'by_new_wishlist';?>"
                                            data-product_id="{{$product->id}}"
                                            data-size_id="{{$new_products_row->size_id}}" data-flags='1'
                                            data-toggle="pill" type="button">
                                    ...
                                    <div class="item">
                                        <button
                                            class="pills-general pills-link-new-product pills-link quantity-disabled "
                                            disabled data-toggle="pill" type="button">
                        ...
                        <div class="product-size-wrapper">
                            <div class="inner product-sizes product-slider-wrapper" id="used-product-sizes">
                                <div
                                    ...
                                    <div class="item" @if(isset($used_product['size']) &&
                                        $used_product['size']=="One Size" ) style="width:0%;margin-left:207%;" @endif>
                                        <div class="item-wrapper">
                                            <button class="pills-general pills-link-used-product pills-link
                                                    ...
                                                    //     }
                                                    ?>" data-product_id="{{$product->id}}"
                                                data-size_id="{{$used_product['id']}}" data-flags='2' data-toggle="pill"
                                                type="button">
                                                {{$used_product['size']}}
                                    ...
                                    <div class="item">
                                        <div class="item-wrapper">
                                            <button class="pills-general pills-link-used-product pills-link
                                                        <?php //if($used_product->product_sizes_quantity < 1 ){ echo "
                                                quantity-disabled"; } ?>"
                                                data-product_id="{{$product->id}}"
                                                data-size_id="{{$used_product->size_id}}" data-flags='2'
                                                data-toggle="pill" type="button">
                                                {{$used_product->size}}
                                                <?php
                                                           ...
                                                           // if($getprice){?>
                                                <span
                                                    class="pill-price">£{{number_format($getprice->sale_price,2)}}</span>
                                                <?php //} ?>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="item-wrapper">
                                            <button
                                                class="pills-general pills-link-used-product pills-link
                                                                        <?php if($used_product->product_sizes_quantity < 1 ){ echo "
                                                quantity-disabled"; } ?>"
                                                data-product_id="{{$product->id}}"
                                                data-size_id="{{$used_product->size_id}}" data-flags='2'
                                    ...
                                    <div class="item">
                                        <div class="item-wrapper">
                                            <button
                                                class="pills-general pills-link-used-product pills-link quantity-disabled"
                                                disabled data-toggle="pill" type="button">
                                                {{$adminSizesIs['size_name']}}
                                            </button>
                                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button id="close_button_model" type="button" class="close" data-dismiss="modal"
                            aria-label="Close">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="size_guide_div table-responsive">
                            ...
                            <table class="size_guide_table table">
                                {{-- get all sizes --}}
                                @php $sizeidsGet = []; @endphp
                                @foreach($adminSizes as $row)
                                @php $sizeidsGet[] = $row['size_id']; @endphp
                                @endforeach
                                @php
                                $getSizeTitile =
                                App\Models\SizeGuide::where('brand_id',$product->brand_id)->where('shop_category_id',$product->shop_category_id)->where('gender',$product->gender)->whereIn('size_id',$sizeidsGet)->orderBy("guide_size_title",
                                "ASC")->groupBy('guide_size_title')->get();
                                @endphp
                                {{-- get all sizes --}}

                                <tr>
                                    <th>Size</th>
                                    @foreach($getSizeTitile as $row)
                                    <th>{{ucfirst($row->guide_size_title)}}</th>
                                    @endforeach
                                </tr>
                                ...
                                <tr>
                                    ...
                                    @php
                                    $allSizeGuide =
                                    App\Models\SizeGuide::where('brand_id',$product->brand_id)->where('shop_category_id',$product->shop_category_id)->where('gender',$product->gender)->where('size_id',$adminSizesIs['size_id'])->where('guide_size_title',
                                    $row->guide_size_title)->first();
                                    @endphp
                                    @if($allSizeGuide)
                                    <td>{{$allSizeGuide->guide_size}}</td>
                                    @else
                                    <td></td>
                                    @endif
                                    @endforeach
                                    ...
                                    {{-- @php
                                    $allSizeGuide =
                                    App\Models\SizeGuide::where('brand_id',$product->brand_id)->where('shop_category_id',$product->shop_category_id)->where('gender',$product->gender)->where('size_id',$adminSizesIs['size_id'])->get();
                                    @endphp
                        ...
                        {{-- <div id="accordionlvl1">
                            <div class="card">
                                <div class="card-header">
                                    <button class="btn btn-link collapsed" data-toggle="collapse"
                                        data-target="#lvl1_collapseOne" aria-expanded="false"
                                        aria-controls="lvl1_collapseOne">
                                        Men
                                    </button>
                                </div>
                                        ...
                                        <div id="menAcc">
                                            <div class="card">
                                                <div class="card-header" id="headingOne">
                                                    ...
                                                    <button class="btn btn-link collapsed" data-toggle="collapse"
                                                        data-target="#menAcc_collapseOne" aria-expanded="false"
                                                        aria-controls="menAcc_collapseOne">
                                                        Clothing
                                                    </button>

                                                </div>
                                                <div id="menAcc_collapseOne" class="collapse"
                                                    aria-labelledby="headingOne" data-parent="#menAcc">
                                                    <div class="card-body">
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingTwo">
                                                    ...
                                                    <button class="btn btn-link collapsed" data-toggle="collapse"
                                                        data-target="#menAcc_collapseTwo" aria-expanded="false"
                                                        aria-controls="menAcc_collapseTwo">
                                                        Footwear
                                                    </button>

                                                </div>
                                                <div id="menAcc_collapseTwo" class="collapse"
                                                    aria-labelledby="headingTwo" data-parent="#menAcc">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                                <thead>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="menAcc_collapseThree" class="collapse"
                                                    aria-labelledby="headingThree" data-parent="#menAcc">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                                <thead>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <button class="btn btn-link collapsed" data-toggle="collapse"
                                        data-target="#lvl1_collapsetwo" aria-expanded="false"
                                        aria-controls="lvl1_collapsetwo">
                                        Women
                                    </button>
                                        ...
                                        <div id="womenAcc">
                                            <div class="card">
                                                <div class="card-header" id="headingOne">
                                                    ...
                                                    <button class="btn btn-link collapsed" data-toggle="collapse"
                                                        data-target="#womenAcc_collapseOne" aria-expanded="false"
                                                        aria-controls="womenAcc_collapseOne">
                                                        Clothing
                                                    </button>

                                                </div>
                                                <div id="womenAcc_collapseOne" class="collapse"
                                                    aria-labelledby="headingOne" data-parent="#womenAcc">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                                <thead>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingTwo">
                                                    ...
                                                    <button class="btn btn-link collapsed" data-toggle="collapse"
                                                        data-target="#womenAcc_collapseTwo" aria-expanded="false"
                                                        aria-controls="womenAcc_collapseTwo">
                                                        Footwear
                                                    </button>

                                                </div>
                                                <div id="womenAcc_collapseTwo" class="collapse"
                                                    aria-labelledby="headingTwo" data-parent="#womenAcc">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                                <thead>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="womenAcc_collapseThree" class="collapse"
                                                    aria-labelledby="headingThree" data-parent="#womenAcc">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                                <thead>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <button class="btn btn-link collapsed" data-toggle="collapse"
                                        data-target="#lvl1_collapseThree" aria-expanded="false"
                                        aria-controls="lvl1_collapseThree">
                                        Junior
                                    </button>
                                    ...
                                    <div class="card-body">
                                        <div id="juniorAcc">
                                            <div class="card">
                                                ...
                                                <div id="juniorAcc_collapseOne" class="collapse"
                                                    aria-labelledby="headingOne" data-parent="#juniorAcc">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                                <thead>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="juniorAcc_collapseTwo" class="collapse"
                                                    aria-labelledby="headingTwo" data-parent="#juniorAcc">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                                <thead>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="juniorAcc_collapseThree" class="collapse"
        ...
        <div class="product-info">
            ...
            <div class="">
                ...
                <p><span>Gender</span>
                    ...
                    @php
                        $gender = ($product->gender == 1) ? 'menswear' : (($product->gender == 2) ? 'womenswear' : 'children');
                    @endphp
            ...
            <div class="">
                ...
                <p><span>Category</span>
                    ...
                    @php
                    $gender = ($product->gender == 0) ? 'man' : (($product->gender == 1) ? 'woman' : 'children');
                    @endphp



                    <a href="{{route('product.category',
                                 ['gender_slug'=> $gender,'category_slug'=>$product->shop_category->shop_cat_slug])}}">
                        {{ $product->shop_category->shop_cat_name }}
                ...
                <div class="card product-card {{ $productOutOfStock < 1 ?'out_of_stock_product':''}} ">
                    ...
                    <div class="card-body" style="text-align:center;">
                        <div class="product-category">
                            ...
                            {{-- <a
                                href="{{route('product.category',['slug'=>$product->shop_category->shop_cat_slug])}}">
    ...
    <div class="recently-viewed-products">
        <div class="container">
            ...
            <div class="alert alert-dismissible fade" role="alert" style="text-align:center;">
                <button id="error_model" type="button" class="close buttonAlert" data-dismiss="alert" aria-label="Close"
                    onclick="closeup();">
...
{{-- <a href="#" class="btn btn-lg btn-success" data-toggle="modal" data-target="#comparebasicModal">Click to open
    Modal</a> --}}
<!-- basic modal -->
<div class="modal fade" id="comparebasicModal" tabindex="-1" role="dialog" aria-labelledby="comparebasicModal"
    aria-hidden="true">
...
<div class="fixed-buttons">
    ...
    <a href="javascript:void(0)" class="btn blue-btn buy_used" style="border-left: 1px solid #25252d;">buy Pre-Loved
    </a>
...
<script>
    $(document).ready(function() {
        ...
        localStorage.setItem('sku', JSON.stringify(dataToSave));
    });
    $(document).ready(function () {   
