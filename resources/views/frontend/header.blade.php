                ...
                <div class="collapse" id="shopMainCollapse">
                    <ul class="inner-list">
                        ...
                        <li>
                            ...
                            <?php $child_cats = App\Models\ShopCategory::whereRaw("flags & ? = ?", [App\Models\ShopCategory::FLAG_ACTIVE, App\Models\ShopCategory::FLAG_ACTIVE])->where('parent_id',$parent_category['id'])->orderBy('shop_cat_name', 'ASC')->get()->toArray(); ?>
                            <?php if(count($child_cats)>0){ ?>
                            <a data-toggle="collapse" href="#<?php echo $parent_category['shop_cat_name'];?>"
                               class="icon-wrapper"><i class="text-right fas fa-chevron-down"></i>
                                    ...
                                    <ul class="inner-list">
                                      ...
                                      <?php foreach ($child_cats as $key => $child_cat) { ?>
                                           ...
                                           ?>
                                             ...
                                             <li> <a href="{{ route('product.category', ['gender_slug' => $gender_name, 'category_slug' => $child_cat['shop_cat_slug']]) }}" class="dropdown-item">
                                                <?php if ($child_cat['shop_cat_name'] == "Trouser") {
                                                    echo $child_cat['shop_cat_name'] . "s";
                                                } else {
                                                    echo $child_cat['shop_cat_name'];
                        ...
                        <li>
                            <a data-toggle="collapse" href="#brands" class="icon-wrapper"><i
                                    class="text-right fas fa-chevron-down"></i> Brands</a>
                           <div class="collapse" id="brands">
                                <ul class="inner-list">
                                    <?php 
                                    // Retrieve and sort brands alphabetically
                                    ...
                                    foreach ($brands as $key => $brand) {
                                    ?>
                                    <li> <a href="{{route('product.brand',[$brand['brand_slug']])}}" class="dropdown-item"><?php echo $brand['brand_name']; ?></a></li>
                                    <?php }?>
                                </ul>
                            </div>
