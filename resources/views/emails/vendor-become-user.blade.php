                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 60px; padding-bottom: 20px;" align="center"
                                                ...
                                                <a href="#" style="text-decoration:none" target="_blank">
                                                    <img alt="" border="0"
                                                        src="<?php echo url('assets/images/logo-black.png');?>"
                                                        style="width:100%;max-width:267px;height:auto;display:block"
                                                        width="150">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding-bottom: 20px;" align="center" valign="top"
                                                ...
                                                <a href="<?php echo url('/');?>" style="text-decoration:none"
                                                    target="_blank">
                                                    <img alt="" border="0"
                                                    src="https://images-na.ssl-images-amazon.com/images/I/711NDQNFqxL.png"
                                                        style="width:100%;max-width:100px;height:auto;display:block;color: #f9f9f9;"
                                                        width="600">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;"
                                                ...
                                                <h2 class="text"
                                                    ...
                                                    Hi "{{$user->first_name}} &nbsp;{{$user->last_name}} "</h2>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding-bottom: 30px; padding-left: 20px; padding-right: 20px;"
                                                ...
                                                <h4 class="text"
                                                    ...
                                                    Unfortunately!! You are not a vendor, but in future will be togather.</h4>
                                            </td>
                                        </tr>
                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="padding-bottom: 20px;" align="center"
                                                                ...
                                                                <p class="text"
                                                                    ...
                                                                    Thank you so much for using our plateform we can
                                                                    give you the best services. You become our user only. in case if you want to apply to become a seller we will work togather. </p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <td align="center" valign="middle" style="padding-bottom: 40px;"
                                                ...
                                                <a href="#" target="_blank" style="text-decoration:none;">
                                                    <img mc:edit="signature"
                                                        src="<?php echo url('assets/images/signature.png');?>" alt=""
                                                        width="262" border="0" style="width:100%;max-width:262px; height:auto; display:block;">
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px"
                                                ...
                                                <a href="#pintrest-link" style="display: inline-block;" target="_blank"
                                                    class="pintrest">
                                                    <img alt="" border="0"
                                                ...
                                                <a href="#linkdin-link" style="display: inline-block;" target="_blank"
                                                    class="linkdin">
                                                    <img alt="" border="0"
                                        ...
                                        <tr>
                                            <td style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px"
                                                ...
                                                <a href="#App-Store-Link" style="display: inline-block;" target="_blank"
                                                    class="app-store">
                                                    <img alt="" border="0"
