                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 60px; padding-bottom: 20px;" align="center" valign="middle" class="emailLogo">
                                                <a href="#" style="text-decoration:none" target="_blank">
                                                    <img alt="" border="0" src="<?php echo url('assets/images/logo-black.png'); ?>" style="width:100%;max-width:267px;height:auto;display:block" width="150">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-bottom: 30px; padding-left: 20px; padding-right: 20px;" align="center" valign="top" class="subTitle">
                                                <h4 class="text" style="color:#999;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:16px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:24px;text-transform:none;text-align:center;padding:0;margin:0">
                                                    A new product is listed by the Seller {{ $vendor->first_name.' '.$vendor->last_name }}</h4>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" style="padding-bottom: 40px;" class="emailRegards">
                                                ...
                                                <a href="#" target="_blank" style="text-decoration:none;">
                                                    <img mc:edit="signature" src="<?php echo url('assets/images/signature.png'); ?>" alt="" width="262" border="0" style="width:100%;max-width:262px; height:auto; display:block;">
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
